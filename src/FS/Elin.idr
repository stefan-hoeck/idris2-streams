...
export covering
pullListRes : (forall s . Pull s (Elin s) o es ()) -> Result es (List o)
...
export covering
pullChunkRes : (forall s . Pull s (Elin s) o es ()) -> Result es (List $ List o)
...
export covering
streamListRes : (forall s . Stream s (Elin s) es o) -> Result es (List o)
...
export covering
streamChunkRes : (forall s . Stream s (Elin s) es o) -> Result es (List $ List o)
